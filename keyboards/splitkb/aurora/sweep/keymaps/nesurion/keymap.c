...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[2] = LAYOUT_split_3x5_2(KC_EXLM, KC_AT, KC_LCBR, KC_RCBR, KC_ASTR, KC_VOLD, KC_MRWD, KC_MPLY, KC_MFFD, KC_VOLU, KC_HASH, KC_DLR, KC_LPRN, KC_RPRN, KC_BSLS, KC_NO, KC_RSFT, KC_RALT, KC_RCTL, KC_RGUI, KC_PERC, KC_CIRC, KC_LBRC, KC_RBRC, KC_AMPR, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_GRV, KC_ASTR, KC_MINS, KC_EQL),
