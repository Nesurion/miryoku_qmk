...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[1] = LAYOUT_split_3x5_2(KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_MINS, KC_LGUI, KC_LCTL, KC_LALT, KC_LSFT, KC_NO, KC_LEFT, KC_DOWN, KC_UP, KC_RGHT, KC_QUOT, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, LALT(KC_LEFT), KC_PGDN, KC_PGUP, LALT(KC_RGHT), KC_NO, KC_NO, KC_NO, KC_NO, KC_NO),
	[2] = LAYOUT_split_3x5_2(KC_GRV, KC_AT, KC_LCBR, KC_RCBR, KC_MINS, KC_VOLD, KC_MRWD, KC_MPLY, KC_MFFD, KC_VOLU, KC_EXLM, KC_DLR, KC_LPRN, KC_RPRN, KC_BSLS, KC_NO, KC_RSFT, KC_RALT, KC_RCTL, KC_RGUI, KC_CIRC, KC_ASTR, KC_LT, KC_GT, KC_AMPR, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO),
