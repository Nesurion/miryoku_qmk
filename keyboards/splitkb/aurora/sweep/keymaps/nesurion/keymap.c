...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
        ...
        [1] = LAYOUT_split_3x5_2(LGUI(KC_GRV), KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, RCTL(KC_D), RCTL(KC_U), KC_NO, KC_MINS, KC_LSFT, KC_LCTL, KC_LALT, KC_LGUI, KC_NO, KC_LEFT, KC_DOWN, KC_UP, KC_RGHT, KC_QUOT, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, LALT(KC_LEFT), KC_PGDN, KC_PGUP, LALT(KC_RGHT), KC_NO, KC_NO, KC_SPC, KC_ENT, KC_BSPC),
        ...
        [3] = LAYOUT_split_3x5_2(KC_EXLM, KC_AT, KC_LCBR, KC_HASH, KC_CIRC, KC_DLR, KC_PERC, KC_RCBR, KC_AMPR, KC_VOLU, KC_TILD, KC_UNDS, KC_LPRN, KC_BSLS, KC_MINS, KC_EQL, KC_RGUI, KC_RPRN, KC_DQUO, KC_QUOT, KC_GRV, KC_PIPE, KC_LBRC, KC_PSLS, KC_PLUS, KC_ASTR, KC_MPLY, KC_RBRC, KC_MFFD, KC_VOLD, KC_TAB, KC_SPC, KC_NO, KC_BSPC)
};
